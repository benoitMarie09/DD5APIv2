...
router.register('armes', ArmeViewset, basename='arme')
router.register('armures', ArmureViewset, basename='armure')
router.register('capacites', CapaciteViewset, basename='capacite')
